[![Run App IndigoBlood](https://github.com/indigoblood/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/indigoblood/GithubActions/actions/workflows/run-app.yaml)
